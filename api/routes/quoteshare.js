...
router.post("/", async (req, res) => {
  ...
  const { to, subject, text, productId, pdfName, email,name,message, userSelectedItems, imageSource} = req.body;
  ...
  pdf.create(document, options)
      .then(res => {
          ...
          const mailData = {
            ...
            html: "<div>Your configuration is saved and accessible under: https://configurator.mymanifold.com/new-design/"+productId+" </br><div>We are happy to help you finalize your single-use manifold.</div><br></br><h4>Customer Details </h4></br><div>Name:"+name+"</div></br><div>Message:"+message+"</div><div>Email:"+email+"</div></br>",
            attachments: [
              {
